    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mobile'), ('C', 'Camera'), ('MW', 'Men Wear'), ('WW', 'Women Wear'), ('HP', 'Home Appliance'), ('KP', 'Kitchen Appliance')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Accepted', 'Accepted'), ('Dispatched', 'Dispatched'), ('On The Way', 'On The Way'), ('Delivered', 'Delivered'), ('Cancel', 'Cancel')], default='Pending', max_length=30)),
